...
const CATEGORIES = {
  ...
  livechat: { severity: 'high',     autoCreate: null,          label: 'LIVE CHAT', cls: 'tag-livechat' },
...
const KEYWORD_MAP = [
  { keywords: ['live chat', 'chat:start', 'chat:end', 'chat transcript'], category: 'livechat' },
...
class EmailRouter {
  ...
  classify(email) {
    ...
    const bracketMap = {
      'live chat': 'livechat', 'chat': 'livechat', 'chat start': 'livechat', 'chat end': 'livechat',
