...
function serveChatWidget() {
  const JS = `(function(){'use strict';var W='https://sweepnspect-webhook.sweepnspect.workers.dev',P=4000,s={open:false,phase:'intro',sid:null,v:{name:'',email:''},msgs:[],lastTs:'1970-01-01T00:00:00.000Z',pt:null,sending:false};function inj(){var st=document.createElement('style');st.textContent='#snsp-chat-bubble{position:fixed;bottom:20px;right:20px;z-index:99999;width:60px;height:60px;border-radius:50%;background:#ea580c;color:#fff;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 20px rgba(234,88,12,0.45);transition:transform .2s,box-shadow .2s,background .2s}#snsp-chat-bubble:hover{transform:scale(1.08);background:#c2410c;box-shadow:0 6px 28px rgba(234,88,12,0.55)}#snsp-chat-bubble .badge{position:absolute;top:-4px;right:-4px;background:#dc2626;color:#fff;font-size:11px;width:20px;height:20px;border-radius:50%;display:none;align-items:center;justify-content:center}#snsp-chat-window{position:fixed;bottom:92px;right:20px;z-index:99998;width:310px;max-width:calc(100vw - 32px);height:560px;max-height:calc(100vh - 120px);background:linear-gradient(165deg,#28282e 0%,#1a1a1e 12%,#101012 35%,#0c0c0e 65%,#141416 88%,#222226 100%);border-radius:40px;padding:6px;border:3px solid;border-color:#606068 #48484e #2a2a30 #48484e;box-shadow:-12px 16px 45px rgba(0,0,0,0.6),0 8px 30px rgba(0,0,0,0.4),0 0 0 1px rgba(140,140,150,0.2),inset 2px 2px 0 rgba(255,255,255,0.12),inset 0 2px 6px rgba(255,255,255,0.06),inset -2px -2px 0 rgba(0,0,0,0.6),inset 0 -3px 8px rgba(0,0,0,0.3);display:none;flex-direction:column;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;color:#e2e8f0}#snsp-chat-window.open{display:flex}#snsp-chat-window::before{content:\\'\\';position:absolute;right:-5px;top:100px;width:3px;height:40px;background:linear-gradient(180deg,#5a5a62 0%,#3c3c42 40%,#3c3c42 60%,#5a5a62 100%);border-radius:0 3px 3px 0;box-shadow:1px 0 3px rgba(0,0,0,0.5)}#snsp-chat-window::after{content:\\'\\';position:absolute;left:-5px;top:80px;width:3px;height:28px;background:linear-gradient(180deg,#5a5a62 0%,#3c3c42 40%,#3c3c42 60%,#5a5a62 100%);border-radius:3px 0 0 3px;box-shadow:-1px 0 3px rgba(0,0,0,0.5)}.snsp-screen{flex:1;display:flex;flex-direction:column;background:#0f172a;border-radius:34px;overflow:hidden;position:relative}.snsp-camera{width:10px;height:10px;background:#06060a;border-radius:50%;position:absolute;top:10px;left:50%;transform:translateX(-50%);z-index:10;border:1.5px solid #1c1c22;box-shadow:inset 0 1px 3px rgba(0,0,0,0.9),0 0 3px rgba(0,0,0,0.4)}.snsp-statusbar{display:flex;align-items:center;justify-content:space-between;padding:8px 20px 4px;font-size:11px;color:#94a3b8;background:#0f172a;min-height:28px}.snsp-statusbar-time{font-weight:600;color:#e2e8f0}.snsp-statusbar-icons{display:flex;gap:4px;align-items:center}.snsp-statusbar-icons svg{opacity:.7}.snsp-header{background:#0f172a;padding:8px 16px 10px;border-bottom:1px solid #1e293b;display:flex;align-items:center;justify-content:space-between}.snsp-header-title{font-weight:600;font-size:15px;display:flex;align-items:center;gap:8px;color:#fff}.snsp-header-title .dot{width:8px;height:8px;border-radius:50%;background:#4ade80}.snsp-close{background:none;border:none;color:#64748b;cursor:pointer;font-size:18px;padding:4px 8px;border-radius:6px}.snsp-close:hover{color:#e2e8f0;background:rgba(255,255,255,.08)}.snsp-body{flex:1;overflow-y:auto;padding:12px 14px;display:flex;flex-direction:column;gap:8px;background:#0f172a}.snsp-intro{display:flex;flex-direction:column;gap:12px;justify-content:center;flex:1}.snsp-intro h3{margin:0 0 4px;font-size:16px;color:#fff}.snsp-intro p{margin:0;font-size:13px;color:#94a3b8;line-height:1.4}.snsp-intro input{background:#1e293b;border:1px solid #334155;color:#e2e8f0;padding:10px 12px;border-radius:8px;font-size:14px;outline:none;width:100%;box-sizing:border-box}.snsp-intro input:focus{border-color:#ea580c}.snsp-intro input::placeholder{color:#64748b}.snsp-start-btn{background:#ea580c;color:#fff;border:none;padding:12px;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;transition:background .2s}.snsp-start-btn:hover{background:#c2410c}.snsp-start-btn:disabled{opacity:.5;cursor:not-allowed}.snsp-msg{max-width:82%;padding:9px 12px;border-radius:16px;font-size:13px;line-height:1.45;word-wrap:break-word}.snsp-msg-visitor{align-self:flex-end;background:#ea580c;color:#fff;border-bottom-right-radius:4px}.snsp-msg-agent,.snsp-msg-ai{align-self:flex-start;background:#1e293b;border:1px solid #334155;border-bottom-left-radius:4px}.snsp-input-area{padding:10px 14px 14px;background:#0f172a;border-top:1px solid #1e293b;display:flex;gap:8px}.snsp-input-area input{flex:1;background:#1e293b;border:1px solid #334155;color:#e2e8f0;padding:9px 12px;border-radius:20px;font-size:13px;outline:none}.snsp-input-area input:focus{border-color:#ea580c}.snsp-input-area input::placeholder{color:#64748b}.snsp-send-btn{background:#ea580c;border:none;color:#fff;width:36px;height:36px;border-radius:50%;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background .2s;flex-shrink:0}.snsp-send-btn:hover{background:#c2410c}.snsp-send-btn:disabled{opacity:.4;cursor:not-allowed}.snsp-homebar{display:flex;justify-content:center;padding:6px 0 8px;background:#0f172a}.snsp-homebar-pill{width:100px;height:4px;border-radius:2px;background:#334155}.snsp-faq-tiles{display:flex;flex-wrap:wrap;gap:6px;padding:4px 0}.snsp-faq-tile{background:#1e293b;color:#e2e8f0;border:1px solid #334155;padding:6px 10px;border-radius:14px;font-size:11px;cursor:pointer;transition:background .2s;line-height:1.3}.snsp-faq-tile:hover{background:#334155}.snsp-powered{text-align:center;padding:2px 0;font-size:9px;color:#475569;background:#0f172a}.snsp-powered a{color:#64748b;text-decoration:none}';document.head.appendChild(st)}function esc(t){var d=document.createElement('div');d.textContent=t||'';return d.innerHTML}function create(){var b=document.createElement('div');b.id='snsp-chat-bubble';b.innerHTML='<svg viewBox="0 0 24 24" width="28" height="28" fill="#fff"><path d="M12 2C6.477 2 2 6.145 2 11.243c0 2.837 1.37 5.378 3.527 7.09L4 22l4.322-2.16C9.478 20.27 10.707 20.486 12 20.486c5.523 0 10-4.145 10-9.243S17.523 2 12 2z"/></svg><span class="badge" id="snspBadge">0</span>';b.onclick=function(){var w=document.getElementById('snsp-chat-window');s.open=!w.classList.contains('open');w.classList.toggle('open',s.open)};document.body.appendChild(b);var w=document.createElement('div');w.id='snsp-chat-window';w.innerHTML='<div class="snsp-screen"><div class="snsp-camera"></div><div class="snsp-statusbar"><span class="snsp-statusbar-time">SweepNspect</span><span class="snsp-statusbar-icons"><svg width="12" height="12" fill="#94a3b8" viewBox="0 0 24 24"><path d="M1 9l2 2c4.97-4.97 13.03-4.97 18 0l2-2C16.93 2.93 7.08 2.93 1 9zm8 8l3 3 3-3a4.237 4.237 0 00-6 0zm-4-4l2 2a7.074 7.074 0 0110 0l2-2C15.14 9.14 8.87 9.14 5 13z"/></svg><svg width="12" height="12" fill="#94a3b8" viewBox="0 0 24 24"><path d="M15.67 4H14V2h-4v2H8.33C7.6 4 7 4.6 7 5.33v15.33C7 21.4 7.6 22 8.33 22h7.33c.74 0 1.34-.6 1.34-1.33V5.33C17 4.6 16.4 4 15.67 4z"/></svg></span></div><div class="snsp-header"><div class="snsp-header-title"><span class="dot"></span> Live Chat</div><button class="snsp-close" onclick="document.getElementById(\\'snsp-chat-window\\').classList.remove(\\'open\\')">&times;</button></div><div class="snsp-body" id="snspBody"></div></div>';document.body.appendChild(w);introUI()}function introUI(){var b=document.getElementById('snspBody');b.innerHTML='<div class="snsp-intro"><h3>Hi there! \\u{1F44B}</h3><p>Have a question about SweepNspect? We\\'re here to help.</p><input type="text" id="snspName" placeholder="Your name"><input type="email" id="snspEmail" placeholder="Email (optional)"><button class="snsp-start-btn" id="snspStartBtn" onclick="window._snspStart()">Start Chat</button></div>'}window._snspStart=async function(){var n=document.getElementById('snspName'),e=document.getElementById('snspEmail'),b=document.getElementById('snspStartBtn');var name=(n.value||'').trim();if(!name){n.style.borderColor='#ea580c';n.focus();return}s.v.name=name;s.v.email=(e.value||'').trim();b.disabled=true;b.textContent='Connecting...';try{var r=await post('/api/chat/start',{name:s.v.name,email:s.v.email});if(r.ok&&r.sessionId){s.sid=r.sessionId;s.phase='chat';chatUI();startPoll()}else{b.textContent='Error - retry';b.disabled=false}}catch(x){b.textContent='Connection failed - retry';b.disabled=false}};function chatUI(){var b=document.getElementById('snspBody');b.innerHTML='<div id="snspMessages" style="flex:1;overflow-y:auto;display:flex;flex-direction:column;gap:8px;padding-bottom:8px"></div><div class="snsp-input-area"><input type="text" id="snspInput" placeholder="Message..." onkeydown="if(event.key===\\'Enter\\')window._snspSend()"><button class="snsp-send-btn" onclick="window._snspSend()"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg></button></div><div class="snsp-powered">Powered by <a href="https://sweepnspect.com" target="_blank">SweepNspect</a></div><div class="snsp-homebar"><div class="snsp-homebar-pill"></div></div>';addMsg('agent','Hi '+esc(s.v.name)+'! How can we help you today?');showFaq();document.getElementById('snspInput').focus()}function showFaq(){var ms=document.getElementById('snspMessages');if(!ms)return;var t=document.createElement('div');t.className='snsp-faq-tiles';t.id='snspFaqTiles';['How much does it cost?','What is the Founding 25?','Does it work offline?','What devices supported?'].forEach(function(q){var ti=document.createElement('span');ti.className='snsp-faq-tile';ti.textContent=q;ti.onclick=function(){var inp=document.getElementById('snspInput');if(inp)inp.value=q;window._snspSend()};t.appendChild(ti)});ms.appendChild(t)}window._snspSend=async function(){var i=document.getElementById('snspInput');if(!i||s.sending)return;var t=i.value.trim();if(!t)return;i.value='';s.sending=true;addMsg('visitor',t);try{await post('/api/chat/message',{sessionId:s.sid,text:t})}catch(x){}s.sending=false;i.focus()};function addMsg(f,t){s.msgs.push({from:f,text:t,ts:new Date().toISOString()});renderMsgs()}function renderMsgs(){var el=document.getElementById('snspMessages');if(!el)return;el.innerHTML=s.msgs.map(function(m){var c=m.from==='visitor'?'snsp-msg-visitor':m.from==='ai'?'snsp-msg-ai':'snsp-msg-agent';var l=m.from==='visitor'?'':m.from==='ai'?'<div style="font-size:10px;color:#64748b;margin-bottom:2px">AI Assistant</div>':'<div style="font-size:10px;color:#64748b;margin-bottom:2px">Support</div>';return'<div class="snsp-msg '+c+'">'+l+esc(m.text)+'</div>'}).join('');el.scrollTop=el.scrollHeight}function startPoll(){if(s.pt)return;s.pt=setInterval(poll,P)}async function poll(){if(!s.sid)return;try{var d=await get('/api/chat/messages?session='+s.sid+'&after='+encodeURIComponent(s.lastTs));if(d.messages&&d.messages.length>0){for(var i=0;i<d.messages.length;i++){var m=d.messages[i];if(m.from==='visitor'){if(m.ts>s.lastTs)s.lastTs=m.ts;continue}if(!s.msgs.find(function(x){return x.id===m.id}))s.msgs.push(m);if(m.ts>s.lastTs)s.lastTs=m.ts}renderMsgs()}if(d.status==='ended'){clearInterval(s.pt);s.pt=null;addMsg('agent','Chat ended. Thanks for reaching out!')}}catch(x){}}async function post(p,b){var r=await fetch(W+p,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(b)});return r.json()}async function get(p){var r=await fetch(W+p);return r.json()}function init(){inj();create()}if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',init);else init()})();`;
